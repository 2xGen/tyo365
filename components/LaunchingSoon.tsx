    ...
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <p className="text-slate-600 text-center max-w-2xl mx-auto mb-10">
          We’re currently finalizing tour categories, comparison guides, and structured experience pages. Tyo365 will soon become the most complete and focused destination for:
        </p>
        ...
        <p className="font-display font-semibold text-slate-800 text-center text-lg mb-8" style={{ fontFamily: "var(--font-display), system-ui, sans-serif" }}>
          Everything Tokyo. 365 Days a Year.
        </p>
        ...
        <div className="flex flex-wrap justify-center gap-4">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 px-5 py-3 rounded-xl font-medium text-white bg-[#25D366] hover:bg-[#20bd5a] btn-lift shadow-md"
          >
